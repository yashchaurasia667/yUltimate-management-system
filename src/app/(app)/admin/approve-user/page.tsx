...
const mockStudents: Student[] = [
  { _id: "student1", name: "Alice Johnson", age: 22, address: "123 Oak St", city: "Springfield", state: "IL", type: "student" },
  { _id: "student2", name: "Bob Smith", age: 19, address: "45 Pine Ln", city: "Shelbyville", state: "KY", type: "student" },
];

const mockCoaches: Coach[] = [
  { _id: "coach1", name: "Dr. Charlie Brown", age: 45, address: "78 Elm Rd", city: "Capital City", state: "NY", type: "coach", course: "Advanced Theoretical Physics" },
  { _id: "coach2", name: "Eva Mendes", age: 30, address: "90 Maple Ave", city: "Metro City", state: "CA", type: "coach", course: "Frontend Web Development" },
];
    ...
    <div className="bg-white p-5 border border-gray-200 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col justify-between">
      <div>
        ...
        <div className="space-y-1 text-gray-700 text-sm">
          ...
          <p className="text-xs text-gray-400 truncate"><strong>ID:</strong> {user._id}</p>
        </div>
...
const App = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const studentsData = studentsResult.status === "fulfilled" && Array.isArray(studentsResult.value) 
        ...
        setError("Could not retrieve data. Displaying mock data.");
  ...
  const handleApproval = async (id: string, userType: "student" | "coach", action: "approve" | "reject") => {
    ...
    try {
      const res = await axios.post("/api/updateApprove", payload);
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-8 font-sans">
      <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        {/* Action Message Bar */}
        {actionMessage && (
            <div className={`p-4 text-center font-medium ${actionMessage.type === 'success' ? 'bg-[#a7d3c9] text-[#2a9d8f]' : 'bg-red-100 text-red-600'}`}>
