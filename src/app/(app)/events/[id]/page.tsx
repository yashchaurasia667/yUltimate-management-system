...
const Page = ({ title, description, organizer, banner, date, venue, type }: details) => {
  // const { title, description, organizer, banner, date, venue, type } = res.data;
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto p-6 relative">
        <div className="bg-white rounded-lg shadow-xl p-8 -mt-24 sm:-mt-32">
          ...
          <div className="text-center">
            <button
              className="bg-blue-600 text-white font-bold py-3 px-10 rounded-full text-lg 
      ...
      <footer className="text-center p-6 text-gray-500 mt-8">
        © {new Date().getFullYear()} {organizer}. All rights reserved.
      </footer>
    </div>
  );
};
